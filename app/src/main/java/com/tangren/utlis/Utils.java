...
public class Utils {
    ...
    //打印
    public static void print(final String amountMoney, final String shishou, final String zhaoling, final String out_trade_no) {
        new Thread(new Runnable() {
            @Override
            public void run() {
                new MyUtil().print("深圳市小兵智能科技有限公司", amountMoney, "0.00", shishou, zhaoling, "P" + out_trade_no);
            }
        }).start();
    }

    public static void addNum(String num, TextView textView) {
            String result = textView.getText().toString().trim() + num;
